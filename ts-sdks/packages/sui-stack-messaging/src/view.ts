...
import type { SuiStackMessagingBCS } from './bcs.js';
import type { SuiStackMessagingDerive } from './derive.js';
...
export interface SuiStackMessagingViewOptions {
...
export class SuiStackMessagingView {
	#client: ClientWithCoreApi;
	#derive: SuiStackMessagingDerive;
	#bcs: SuiStackMessagingBCS;
	#packageConfig: SuiStackMessagingPackageConfig;
	...
	constructor(options: SuiStackMessagingViewOptions) {
